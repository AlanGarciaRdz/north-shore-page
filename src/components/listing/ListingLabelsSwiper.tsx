...
interface ListingLabelsSwiperProps {
...
const ListingLabelsSwiper: FC<ListingLabelsSwiperProps> = ({
  onChangeListing,
  listings,
  addMarginLeft,
  showLength,
              ...
              >
                {isActive && index !== 0 && (
                  <Button
                    light
                    auto
                    icon={<MdChevronLeft style={{ fontSize: theme?.fontSizes.md.value }} />}
...
export default ListingLabelsSwiper;
