...
const DevelopmentAmenities_1 = __importDefault(require("../DevelopmentAmenities"));
      ...
      <react_1.Grid.Container>
        <react_1.Grid xs={12}>
          <react_1.Grid.Container justify='space-between'>
            ...
            var _a;
            return (<react_1.Button key={developmentHeaderIndex} light auto css={{ padding: 0, marginRight: 8 }} onClick={() => {
                    if (swiperRef.current) {
                        swiperRef.current.slideTo(developmentHeaderIndex);
                    }
                }}>
                    <react_1.Text weight={((_a = swiperRef.current) === null || _a === void 0 ? void 0 : _a.activeIndex) ===
                    developmentHeaderIndex
                    ? 'bold'
                    : 'normal'}>{`0${developmentHeaderIndex + 1}.`}</react_1.Text>
                  </react_1.Button>);
        })}
            </react_1.Grid>
            <react_1.Grid css={{
            ...
            flexDirection: 'row',
              ...
              <react_1.Button auto disabled={((_a = swiperRef.current) === null || _a === void 0 ? void 0 : _a.activeIndex) === 0} onClick={() => {
            if (swiperRef.current) {
            ...
            marginRight: 8,
              ...
              <react_1.Button auto disabled={((_b = swiperRef.current) === null || _b === void 0 ? void 0 : _b.activeIndex) === developments.length - 1} onClick={() => {
            if (swiperRef.current) {
        ...
        <react_1.Grid xs={12} css={{ marginBottom: 15 }}>
          <link_1.default href={development.url || '/'}>
            <react_1.Button light auto css={{ padding: 0, margin: 0 }} onClick={() => { }}>
              <react_1.Text h2>{development.name}</react_1.Text>
            </react_1.Button>
          </link_1.default>
        </react_1.Grid>
        <react_1.Grid xs={12}>
          <link_1.default href={((_c = development.listing) === null || _c === void 0 ? void 0 : _c.url) || '/'}>
            ...
            '.nextui-button-icon': { marginRight: 4 },
              ...
              <react_1.Text>{(_d = development.listing) === null || _d === void 0 ? void 0 : _d.name}</react_1.Text>
            </react_1.Button>
          </link_1.default>
        </react_1.Grid>
        ...
        <react_1.Grid xs={12} css={{ marginBottom: 28 }}>
          <DevelopmentData_1.default squareFT={(_e = development.squareFT) === null || _e === void 0 ? void 0 : _e.toString()} bedrooms={(_f = development.bedrooms) === null || _f === void 0 ? void 0 : _f.toString()} bathrroms={(_g = development.bathrroms) === null || _g === void 0 ? void 0 : _g.toString()} bigData/>
        </react_1.Grid>
        <react_1.Grid xs={12} css={{ marginBottom: 20 }}>
          <link_1.default href={development.url || '/'}>
            <react_1.Button auto css={{
            width: '100%',
        ...
        <react_1.Grid xs={12}>
          <react_1.Button auto bordered css={{
            width: '100%',
        }}>
            {'Contact agent'}
          </react_1.Button>
